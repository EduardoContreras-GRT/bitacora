    ...
    <div class="row">
        ...
        <div class="outer-w3-agile col-xl">
            <div class="stat-grid p-3 d-flex align-items-center justify-content-between bg-primary">
                <div class="s-l">
                    <h5>Leads</h5>
                    <p class="paragraph-agileits-w3layouts text-white">Total de mes</p>
                </div>
                <div class="s-r">
                    <h6>340 - 100%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-success">
                <div class="s-l">
                    <h5>Contactados</h5>
                    <p class="paragraph-agileits-w3layouts">Leads contactados</p>
                </div>
                <div class="s-r">
                    <h6>250 - 73%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-secondary">
                <div class="s-l">
                    ...
                    <p class="paragraph-agileits-w3layouts">Leads contactados con cita agendada</p>
                </div>
                <div class="s-r">
                    <h6>180 - 72%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-warning">
                <div class="s-l">
                    ...
                    <p class="paragraph-agileits-w3layouts">Leads con cita asistida</p>
                </div>
                <div class="s-r">
                    <h6>80 - 44%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-info">
                <div class="s-l">
                    <h5>Pedidos</h5>
                    <p class="paragraph-agileits-w3layouts">Leads con pedido</p>
                </div>
                <div class="s-r">
                    <h6>30 - 37%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-dark">
                <div class="s-l">
                    <h5>Ventas</h5>
                    <p class="paragraph-agileits-w3layouts">Leads vendidos</p>
                </div>
                <div class="s-r">
                    <h6>13 - 43%
            ...
            <div class="stat-grid p-3 mt-3 d-flex align-items-center justify-content-between bg-danger">
                <div class="s-l">
                    <h5>Conversi&oacute;n</h5>
                    <p class="paragraph-agileits-w3layouts">Porcentaje de conversi&oacute;n</p>
                </div>
                <div class="s-r">
                    <h6> 3.8%
        ...
        <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
            <h4 class="tittle-w3-agileits mb-4">Análisis de Leads</h4>
            <div id="chartdiv"></div>
            <div id="Hybridgraph" class="simple-chart1"></div>
        </div>
        <!--// Pie-chart -->
    </div>
</div>
