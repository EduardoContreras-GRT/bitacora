...
<div class="row">
    <div class="jumbotron col-lg-4" id="form">
        ...
        <form>
            ...
            <div class="form-group">
                <label for="nombreAEtapa">Nombre de Etapa</label>
                <input type="text" class="form-control" id="nombreAEtapa" >
            </div>
            <div class="form-group">
                <label for="nombreAgencia">Descripción de Etapa</label>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
            <th scope="col">#</th>
            <th scope="col">Nombre de Etapa</th>
