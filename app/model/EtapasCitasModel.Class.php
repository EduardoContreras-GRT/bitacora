...
class EtapasCitasModel{

   
    private $table = "etapascitas";
    private $data = "";
    private $fields = "";
    private $where = "";
    private $idValues = "";
    ...
    public function updateEtapasCitas($data = [], $idValues = []){
        $this->data = $data;
    ...
    public function deleteEtapasCitas($idValues = []){      
        $this->idValues = $idValues;
        $dataArray = ["table" => $this->table, "idValues" => $this->idValues];
        $Connection = new Connect();
        return $Connection->delete($dataArray);
    }
    public function selectEtapasCitas($tables = "", $fields = "", $where = ""){
        $this->table = $tables;
        $this->fields = $fields;
        $this->where = $where;
