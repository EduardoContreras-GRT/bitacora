...
class MetodoCompraModel{

   
    private $table = "metodoscompras";
    private $data = "";
    private $fields = "";
    private $where = "";
    private $idValues = "";
    ...
    public function insertMetodoCompra($data = []){
        $this->data = $data;
        $dataArray = ["table" => $this->table, "data" => $this->data, "pk" => "idMetodoCompra"];
        $Connection = new Connect();
        return $Connection->insert($dataArray);
    }

    public function updateMetodoCompra($data = [], $idValues = []){
        $this->data = $data;
    ...
    public function deleteMetodoCompra($idValues = []){      
        $this->idValues = $idValues;
        $dataArray = ["table" => $this->table, "idValues" => $this->idValues];
        $Connection = new Connect();
        return $Connection->delete($dataArray);
    }
    public function selectMetodoCompra($tables = "", $fields = "", $where = ""){
        $this->table = $tables;
        $this->fields = $fields;
        $this->where = $where;
